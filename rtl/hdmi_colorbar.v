...
// Description   : hdmi_colorbar顶层模块（1080@30）
// 
// Revision      : V1.0
// Additional Comments:
////////////////////////////////////////////////////////////////////////
...
(
    ...
    .c0         (vga_clk    ),  //输出VGA工作时钟,频率 Mhz,1bit
    .c1         (clk_5x     ),	//输出倍频
...
(
    ...
    .pix_y      (pix_y      ),  //输入VGA有效显示区域像素点Y轴坐标,10bit
	 .pix_num	 (pix_num	 ), //输入pix编号
    .pix_data   (pix_data   )   //输出像素点色彩信息,16bit

);
//------------- pix_change_inst -------------
pix_change pix_change_inst
(
	.sys_clk    (sys_clk    ),  
   .sys_rst_n  (rst_n      ),
	.key_in		(key_in		),
